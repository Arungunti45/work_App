...
exports.onMessageCreated = exports.createConversation = void 0;
...
exports.createConversation = functions.https.onCall(async (data, context) => {
    ...
    if (await (0, safety_1.isBlocked)(workerId, employerId)) {
        throw new functions.https.HttpsError('permission-denied', 'Communication is not available between these accounts.');
    }
...
exports.onMessageCreated = functions.firestore
    ...
    for (const recipientId of recipients) {
        ...
        await (0, notifications_1.sendPushToUser)(recipientId, `New message from ${senderName}`, 'You have a new message.', `/messages/${conversationId}`);
    }
    return null;
});
