...
exports.cleanupExpiredNotifications = exports.sendInterviewReminders = void 0;
...
async function createNotification(opts) {
    const { recipientId, type, category, title, body, priority = 'NORMAL', route, entityType, entityId, metadata, idempotencyKey } = opts;
    try {
